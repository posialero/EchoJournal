...
import com.posialero.echojournal.echos.presentation.echos.models.RelativePosition
import com.posialero.echojournal.echos.presentation.echos.models.TrackSizeInfo
import com.posialero.echojournal.echos.presentation.preview.PreviewModels
...
private fun EchoListPreview() {
    EchoJournalTheme {
        ...
        val fromTwoDaysAgoEchos = remember {
            (1..3).map {
                PreviewModels.echoUi.copy(
                    id = it + 6,
        ...
        val sections = remember {
            listOf(
                ...
                EchoDaySection(
                    ...
                    echos = yestardaysEchos
                ),
                EchoDaySection(
                    dateHeader = UiText.Dynamic("2025/10/19"),
                    echos = fromTwoDaysAgoEchos
                )
            )
        }
