...
import com.posialero.echojournal.core.presentation.designsystem.chips.MultiChoiceChip
import com.posialero.echojournal.core.presentation.designsystem.dropdowns.Selectable
import com.posialero.echojournal.core.presentation.designsystem.dropdowns.SelectableDropDownOptionsMenu
import com.posialero.echojournal.core.presentation.util.UiText
import com.posialero.echojournal.echos.presentation.echos.EchosAction
        ...
        MultiChoiceChip(
            ...
            dropDownMenu = {
                SelectableDropDownOptionsMenu(
                    ...
                    leadingIcon = { moodUi ->
                        Image(
                            imageVector = ImageVector.vectorResource(moodUi.iconSet.fillId),
            ...
            dropDownMenu = {
                if (topics.isEmpty()) {
                    ...
                    SelectableDropDownOptionsMenu(
                        ...
                        key = { topic -> topic },
                        onItemClick = { topic ->
                            onAction(EchosAction.OnFilerByTopicClick(topic.item))
                        },
                        dropDownOffset = dropDownOffset,
                        maxDropDownHeight = dropDownMaxHeight,
                        leadingIcon = { topic ->
